...
struct BatteryInfo: Hashable, CustomStringConvertible {
  ...
  static func == (lhs: BatteryInfo, rhs: BatteryInfo) -> Bool {
    ...
    return MessagesPigeonInternal.deepEquals(lhs.level, rhs.level)
  }
  ...
  public var description: String {
    return "BatteryInfo(level: \(String(describing: level)))"
  }
}
...
class BatteryApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: BatteryApi?, messageChannelSuffix: String = "") {
    ...
    let getBatteryInfoChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.flutter_pigeon_demo.BatteryApi.getBatteryInfo\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
