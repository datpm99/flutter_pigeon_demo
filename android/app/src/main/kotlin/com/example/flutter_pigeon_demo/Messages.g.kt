...
data class BatteryInfo (
...
)
 {
  ...
  override fun equals(other: Any?): Boolean {
    ...
    return MessagesPigeonUtils.deepEquals(this.level, other.level)
  }
...
interface BatteryApi {
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: BatteryApi?, messageChannelSuffix: String = "") {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.flutter_pigeon_demo.BatteryApi.getBatteryInfo$separatedMessageChannelSuffix", codec)
        if (api != null) {
